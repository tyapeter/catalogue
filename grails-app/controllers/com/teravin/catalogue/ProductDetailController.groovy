...
class ProductDetailController {
	...
	//	def products = ProductDetail.executeQuery("select pd.product.id as id,pd.product.name as name,pd.product.code as code,pd.product.dateCreated as dateCreated from ProductDetail pd  where pd.product.deleteFlag='N' and pd.material.materialCategory.id=?  and pd.product.model.modelCategory.id=?  order by "+params.sort+" "+params.order,[Long.parseLong(params.materialCategoryId) ,Long.parseLong(params.modelId)],[max:params.max,offset:params.offset])
		def products = ProductDetail.executeQuery("select distinct pd.product.id as id,pd.product.name as name,pd.product.id as code,pd.product.dateCreated as dateCreated from ProductDetail pd  where pd.product.deleteFlag='N' and pd.product.materialMain.id=?  and pd.product.model.modelCategory.id=?  order by "+params.sort+" "+params.order,[Long.parseLong(params.materialCategoryId) ,Long.parseLong(params.modelId)],[max:params.max,offset:params.offset])
	//	def productsCount = Product.executeQuery("select pd.product.id as id,pd.product.name as name,pd.product.code as code,pd.product.dateCreated as dateCreated from ProductDetail pd  where pd.product.deleteFlag='N' and pd.material.materialCategory.id=?  and pd.product.model.modelCategory.id=?  ",[Long.parseLong(params.materialCategoryId) ,Long.parseLong(params.modelId)]).size()
		def productsCount = Product.executeQuery("select distinct pd.product.id as id,pd.product.name as name,pd.product.id as code,pd.product.dateCreated as dateCreated from ProductDetail pd  where pd.product.deleteFlag='N' and pd.product.materialMain.id=?  and pd.product.model.modelCategory.id=?  ",[Long.parseLong(params.materialCategoryId) ,Long.parseLong(params.modelId)]).size()
							...
							if(sizes==1){
								...
								def productDetailId = params.productDetailAccesoriesInstance
									...
									{	System.out.println("productId===="+productDetailId)
										...
										productDetail.updatedBy = springSecurityService.principal.username
										System.out.println("params.accesoriesDelete[i]===="+params.accesoriesDelete[i])
