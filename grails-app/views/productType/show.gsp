            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="productType.idx.label" default="Idx" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: productTypeInstance, field: "idx")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="productType.createdBy.label" default="Created By" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: productTypeInstance, field: "createdBy")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="productType.updatedBy.label" default="Updated By" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: productTypeInstance, field: "updatedBy")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="productType.deleteFlag.label" default="Delete Flag" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: productTypeInstance, field: "deleteFlag")}</td>
