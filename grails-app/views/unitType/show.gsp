            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="unitType.name.label" default="Name" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: unitTypeInstance, field: "name")}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="unitType.description.label" default="Description" /></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean: unitTypeInstance, field: "createdBy")}</td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="unitType.updatedBy.label" default="Updated By" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: unitTypeInstance, field: "updatedBy")}</td>
